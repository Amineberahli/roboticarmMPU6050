...
void loop() {
    ...
    if ((ypr[2] * 180/M_PI <0) && (ypr[2] * 180/M_PI > -10 )) {
      ...
      digitalWrite(5,HIGH);  digitalWrite(4,LOW), digitalWrite(3,LOW); 
    }
    else if ((ypr[2] * 180/M_PI < -10) && (ypr[2] * 180/M_PI > -20)) {
      digitalWrite(5,HIGH) , digitalWrite(4,HIGH), digitalWrite(3,LOW); 
    }
    else if ( ypr[2] * 180/M_PI < -20) {
      digitalWrite(5,HIGH) , digitalWrite(4,HIGH), digitalWrite(3,HIGH); 
    }
    else {
    ...
    if ( (ypr[2] * 180/M_PI >0) && (ypr[2] * 180/M_PI < 10 )) {
      ...
      if ((ypr[1] * 180/M_PI < 10) && (ypr[1] * 180/M_PI > 0)) {
       // digitalWrite(9,HIGH); 
        digitalWrite(13,LOW), digitalWrite(12,LOW); 
        
      }
      else if ((ypr[1] * 180/M_PI < 20) && (ypr[1] * 180/M_PI > 10)) {
        //digitalWrite(9,HIGH);
   ...
   int ValueX= int(ypr[2] * 180/M_PI);
   int posX=map(ValueX,-90,90,0,179);
   Delta.write(posX); 
   int ValueY= int (ypr[1] * 180/M_PI);
   int posY=map(ValueY,-90,90,0,179);
   Alpha.write(posY); 
    int ValueZ = int (ypr[0] * 180/M_PI);
    int posZ=map(ValueZ,-180,180,0,175);
    Omega.write(posZ);
